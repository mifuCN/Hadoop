...
import com.mifu.contant.UserConstant;
import com.mifu.exception.BusinessException;
import com.mifu.model.domain.User;
import com.mifu.service.UserService;
import com.mifu.common.ErrorCode;
import com.mifu.mapper.UserMapper;
...
//            return -1;
    ...
    public User userLogin(String userAccount, String userPassword, HttpServletRequest request) {
        ...
        // 4.记录用户的登录状态
        request.getSession().setAttribute(UserConstant.USER_LOGIN_STATE, safetyUser);//偷个懒 直接用user 服务器上的redis很难被读取(分布式登录时)
        return safetyUser;
    }
    ...
    public int userLogout(HttpServletRequest request) {
        // 移除登录态
        request.getSession().removeAttribute(UserConstant.USER_LOGIN_STATE);//其实有点像对map的操作
        return 1;
    }
}
