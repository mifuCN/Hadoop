...
import com.mifu.model.domain.request.UserLoginRequest;
import com.mifu.model.domain.request.UserRegisterRequest;
...
//            return ResultUtils.error(ErrorCode.PARAMS_ERROR);//这个方法不太好 先去定义一个自定义异常类BussinessException
    ...
    public BaseResponse<User> getCurrentUser(HttpServletRequest request) {
        // 鉴权 仅管理员可查询
        Object userObj = request.getSession().getAttribute(UserConstant.USER_LOGIN_STATE); //获取用户的登录态
